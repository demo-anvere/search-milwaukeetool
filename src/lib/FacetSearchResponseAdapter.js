...
var FacetSearchResponseAdapter = /*#__PURE__*/ (function () {
	function FacetSearchResponseAdapter(
		typesenseResponse,
	...
	;(0, _createClass2["default"])(FacetSearchResponseAdapter, [
		{
			...
			value: function _adaptFacetHits(typesenseFacetCounts) {
				...
				var facet = typesenseFacetCounts.find(function (facet) {
					return (
						facet.field_name ===
						_this.instantsearchRequest.params.facetName
					)
				})
				adaptedResult = facet.counts.map(function (facetCount) {
					return {
						value: facetCount.value,
						highlighted: _this._adaptHighlightTag(
							facetCount.highlighted,
							_this.instantsearchRequest.params.highlightPreTag,
							_this.instantsearchRequest.params.highlightPostTag
						),
